...
let food = ['pizza', 'ramen', 'sushi', 'taco', 'burger', 'chicken']
...
food.push('waffles');
console.log('Added a food to the end.', food);
...
console.log('Foods are now:', food);
...
combineArray = animalArray.concat(food);
